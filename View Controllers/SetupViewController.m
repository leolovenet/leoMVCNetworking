...
- (id)initWithGalleryURLString:(NSString *)galleryURLString
{
    ...
    if (self != nil) {
        ...
        if (self->_choices == nil) {
            ...
            #else
                #define HOSTNAME "Leo-MacBook-Pro.local:8888"
            #endif
...
- (UITableViewCell *)tableView:(UITableView *)tv cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.accessoryType = indexPath.row == (NSInteger)self.choiceIndex ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
...
- (void)presentModallyOn:(UIViewController *)parent animated:(BOOL)animated
{
   ...
   [parent presentViewController:navController animated:animated completion:NULL];
}
